...
function setGlobalVars() {
  ...
  window.grape_viewer = new ViewHandler(
    "grape-anim-class",
    "grape-container",
    "grape-sec"
  );
  ...
  window.eb_viewer = new ViewHandler(
    "eb-web-anim-class",
    "eb-web-container",
    "eb-web-sec"
  );
  window.school_viewer = new ViewHandler(
    "school-anim-class",
    "school-container",
    "school-sec"
  );
  ...
  window.ffsatg_viewer = new ViewHandler(
    "ffsatg-anim-class",
    "ffsatg-container",
    "ffsatg-sec"
  );
  window.eccc_viewer = new ViewHandler(
    "eccc-anim-class",
    "eccc-container",
    "eccc-sec"
  );
...
function scollInProj() {
  var initEl = window.grape_viewer;
  ...
  var slide_in_left =
    "slide-in-left 0.6s cubic-bezier(0.645, 0.045, 0.355, 1) 0.05s 1 normal forwards";
  var slide_in_right =
    "slide-in-right 0.6s cubic-bezier(0.645, 0.045, 0.355, 1) 0.05s 1 normal forwards";
  const widthBool = 570;
  try {
    if (
      (
  ...
  if (window.innerWidth > widthBool) {
    ...
    if (thirdEl.isElementInViewport(thirdEl.elem)) {
      ...
      thirdEl.target_elem.style.animation =
        "slide-in-left-eb 0.6s cubic-bezier(0.645, 0.045, 0.355, 1) 0.05s 1 normal forwards";
    }
